...
function App() {
  return (
    <main className="h-screen w-screen flex flex-col items-center justify-center bg-gray-100 antialiased font-sans">
      <section
        className="flex flex-col items-center justify-center p-6 bg-white rounded-4xl shadow-lg w-full max-w-[768px]"
      ...
      >
        ...
        >
          ...
          >
            <img src="/phantom-lab-logo.png" alt="PhantomLab logo" className="w-6 h-6 rounded" />
            <span className="font-semibold text-gray-800 text-center w-full">
              PhantomLab
            </span>
          </a>
          ...
          >
            <img src="/dirt-logo.png" alt="Dirt logo" className="w-6 h-6 rounded" />
            <span className="font-semibold text-gray-800 text-center w-full">
              Dirt
            </span>
          </a>
